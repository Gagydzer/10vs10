...
var config_colors = ['#de5d4e', '#914EDE', 'purple', 'orange', 'blue'];
var duel_vs_panel = 0;
var duel_bg_panel = 0;
...
var duel_bg_main_slider_counter = 0;
var duel_bg_main_slider_length = 0;
var duel_bg_main_slider_current_left = '0px';

var duel_bg_left_slider_counter = 0;
var duel_bg_left_slider_length = 0;
var duel_bg_left_slider_current_left = '0px';

var duel_bg_right_slider_counter = 0;
var duel_bg_right_slider_length = 0;
var duel_bg_right_slider_current_left = '0px';

// инициализация слайдера
if (duel_vs_slider_counter == 0) {
		$('.duel_vs_panel_container > .duel_arrow.left').addClass('duel_opacity');						
		}
...
function duel_switch_color(color) {
	...
	if (color == '#914EDE') {
		if (duel_config_vs = 'var1') {
		$('.duel_versus svg').fadeOut(); 		
		}
		duel_config_vs_back = duel_config_vs;
		duel_config_vs = 'var2';
		$('.duel_versus').css('background-image', 'url(duel_img/vs2.png)').addClass('scale2');
	}
	if (color == '#de5d4e') {
	...
	if (color != '#de5d4e' && color != '#914EDE') {
		console.log('asdasdasdasdasd');
		duel_switch_color_temp = $('.duel_vs_variants.'+'var3').css('background-image');
		$('.duel_versus').css('background-image', duel_switch_color_temp);
	}
	if (color != '#914EDE') { $('.duel_versus').removeClass('scale2');}
}
...
$('.duel_chose_bg').click( function() {
	...
	if (duel_bg_panel == 0) {
		duel_bg_panel = 1;
		if (duel_vs_panel == 1) {duel_vs_panel = 0}
		$('.duel_bg_panel_slider.'+duel_bg_panel_type).removeClass('duel_display');
		$('.duel_vs_panel_container').removeClass('ph2')}
	else {
		duel_bg_panel = 0; 
		$('.duel_vs_panel_container').removeClass('ph2');
		setTimeout( function () {$('.duel_bg_panel_slider.'+duel_bg_panel_type).removeClass('duel_display');}, 200);
		}
...
$('.my_tooltip.circle .tooltip_switch_icon').on('click', function() {
	...
	setTimeout(function() {	$('.duel-result-body').css('opacity','1');}, 100);
...
$('.my_tooltip.circle .tooltip_delete_icon').on('click', function() {
	...
	setTimeout(function() {	$('.duel-result-body').css('opacity','0');}, 100);
...
$('.duel-flag, .duel_panel_percent_wrapper').click( function() {
...
$('.duel_vs_panel_container > .duel_arrow.right').click( function() {
		...
		if (duel_vs_slider_counter == duel_vs_slider_length) {
		$('.duel_vs_panel_container > .duel_arrow.right').addClass('duel_opacity');						
		}
		if (duel_vs_slider_counter != 0) {
		$('.duel_vs_panel_container > .duel_arrow.left').removeClass('duel_opacity');						
		}
		});
...
$('.duel_vs_panel_container > .duel_arrow.left').click( function() {
		...
		if (duel_vs_slider_counter < duel_vs_slider_length) {
		$('.duel_vs_panel_container > .duel_arrow.right').removeClass('duel_opacity');						
		}		
});

$('.duel_bg_panel_container > .duel_arrow.left').click( function() {	
	if (duel_bg_panel_type == 'main') {
		duel_bg_main_slider_length = $('.duel_bg_panel_slider.main .duel_bg_variants').length - 5;
		if ((duel_bg_main_slider_length - 5 < duel_bg_main_slider_counter)&&(duel_bg_main_slider_counter > 0)) {
		duel_bg_main_slider_counter = --duel_bg_main_slider_counter;
		duel_bg_main_slider_current_left1 = +duel_bg_main_slider_current_left.replace(/px/g, '');
		duel_bg_main_slider_current_left1 = duel_bg_main_slider_current_left1+115;
		duel_bg_main_slider_current_left = duel_bg_main_slider_current_left1+'px'
		console.log(duel_bg_main_slider_current_left)
		$('.duel_bg_panel_slider.main').css('left', duel_bg_main_slider_current_left);
		}
		if (duel_vs_slider_counter == duel_vs_slider_length) {
		$('.duel_vs_panel_container > .duel_arrow.right').addClass('duel_opacity');						
		}
	}
	if (duel_bg_panel_type == 'left') {
			duel_bg_left_slider_length = $('.duel_bg_panel_slider.left .duel_bg_variants').length - 5;
			if ((duel_bg_left_slider_length - 5 < duel_bg_left_slider_counter)&&(duel_bg_left_slider_counter > 0)) {
			duel_bg_left_slider_counter = --duel_bg_left_slider_counter;
			duel_bg_left_slider_current_left1 = +duel_bg_left_slider_current_left.replace(/px/g, '');
			duel_bg_left_slider_current_left1 = duel_bg_left_slider_current_left1+115;
			duel_bg_left_slider_current_left = duel_bg_left_slider_current_left1+'px'
			console.log(duel_bg_left_slider_current_left)
			$('.duel_bg_panel_slider.left').css('left', duel_bg_left_slider_current_left);
			}
		}	
	if (duel_bg_panel_type == 'right') {
			duel_bg_right_slider_length = $('.duel_bg_panel_slider.right .duel_bg_variants').length - 5;
			if ((duel_bg_right_slider_length - 5 < duel_bg_right_slider_counter)&&(duel_bg_right_slider_counter > 0)) {
			duel_bg_right_slider_counter = --duel_bg_right_slider_counter;
			duel_bg_right_slider_current_left1 = +duel_bg_right_slider_current_left.replace(/px/g, '');
			duel_bg_right_slider_current_left1 = duel_bg_right_slider_current_left1+115;
			duel_bg_right_slider_current_left = duel_bg_right_slider_current_left1+'px'
			console.log(duel_bg_right_slider_current_left)
			$('.duel_bg_panel_slider.right').css('left', duel_bg_right_slider_current_left);
			}
		}		
});

$('.duel_bg_panel_container > .duel_arrow.right').click( function() {
	if (duel_bg_panel_type == 'main') {
		duel_bg_main_slider_length = $('.duel_bg_panel_slider.main .duel_bg_variants').length - 5;
		if (duel_bg_main_slider_length > duel_bg_main_slider_counter) {
		duel_bg_main_slider_current_left1 = +duel_bg_main_slider_current_left.replace(/px/g, '');
		console.log(duel_bg_main_slider_current_left);
		duel_bg_main_slider_counter = ++duel_bg_main_slider_counter;
		duel_bg_main_slider_current_left1 = duel_bg_main_slider_current_left1-115;
	...
	if (duel_bg_panel_type == 'left') {
		duel_bg_left_slider_length = $('.duel_bg_panel_slider.left .duel_bg_variants').length - 5;
		if (duel_bg_left_slider_length > duel_bg_left_slider_counter) {
		duel_bg_left_slider_current_left1 = +duel_bg_left_slider_current_left.replace(/px/g, '');
		console.log(duel_bg_left_slider_current_left);
		duel_bg_left_slider_counter = ++duel_bg_left_slider_counter;
		duel_bg_left_slider_current_left1 = duel_bg_left_slider_current_left1-115;
	...
	if (duel_bg_panel_type == 'right') {
		duel_bg_right_slider_length = $('.duel_bg_panel_slider.right .duel_bg_variants').length - 5;
		if (duel_bg_right_slider_length > duel_bg_right_slider_counter) {
		duel_bg_right_slider_current_left1 = +duel_bg_right_slider_current_left.replace(/px/g, '');
		console.log(duel_bg_right_slider_current_left);
		duel_bg_right_slider_counter = ++duel_bg_right_slider_counter;
		duel_bg_right_slider_current_left1 = duel_bg_right_slider_current_left1-115;
