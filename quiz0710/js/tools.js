...
Vue.component('tools', {
    ...
    class="quiz_ask_popup ask_tools" v-bind:style="{top : shift + \'px\'}">\
        ...
        <button class="add_media_button" @click="addUserMedia()" title="Добавить медиа"></button>\
            <media-cats\
            key="media-tools"\
            ...
            >\
                <div slot="media" class="popup_mediacontainer_wrapper">\
                    <div class="popup_mediacontainer_wrapper_wrapper">\
                            <vue-scrollbar classes="my-scrollbar  popup_mediacontainer" ref="Scrollbar">\
    ...
    computed: {
            ...
            shift: function () {
                ...
                var preComputed = ((cover + 200+ 100-200-43)+400+55+(this.currentask)*(600+100)+54*(this.currentanswer)-54*(this.nextanswerid-2))
                return preComputed				
        },
    },
    methods: {
            ...
            toogleResultMediaWatcher: function () {
                this.toogleResultMediaWatcher = !this.toogleResultMediaWatcher
            }
    },
    watch: {
