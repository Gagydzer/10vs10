...
Vue.component('tools-results', {
    ...
    class="quiz_result_popup" style="position: absolute" v-bind:style="{top : shift + \'px\', left : shiftY + \'px\'}">\
    ...
    computed: {
            ...
            shift: function () {
                ...
                var preComputed = (+cover+(this.asks)*630 + - test + 625 + 187-(-51*(this.currentResult)+51*(this.nextResultIndex)))	
                return preComputed		
            },
